...
export const routes: FastifyPluginAsync<{ Core: ICore }> = async function routes(server, { Core }) {
  ...
  server.get<{
    ...
    '/estore/:namespace/token-policies'
  , {
      schema: {
  ...
  server.put<{
    ...
    '/estore/:namespace/token-policies/write-token-required'
  , {
      schema: {
        params: { namespace: namespaceSchema }
      , body: { type: 'boolean' }
  ...
  server.put<{
    ...
    '/estore/:namespace/token-policies/read-token-required'
  , {
      schema: {
        params: { namespace: namespaceSchema }
      , body: { type: 'boolean' }
  ...
  server.put<{
    ...
    '/estore/:namespace/token-policies/delete-token-required'
  , {
      schema: {
        params: { namespace: namespaceSchema }
      , body: { type: 'boolean' }
