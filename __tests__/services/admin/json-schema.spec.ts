...
describe('json schema', () => {
  describe('GET /admin/estore-with-json-schema', () => {
    describe('auth', () => {
      it('200', async () => {
  ...
  describe('GET /admin/estore/<id>/json-schema', () => {
    describe('auth', () => {
      describe('exist', () => {
        it('200', async () => {
          process.env.ESTORE_ADMIN_PASSWORD = 'password'
  ...
  describe('PUT /admin/estore/<id>/json-schema', () => {
    describe('auth', () => {
      describe('valid JSON', () => {
        it('204', async () => {
          process.env.ESTORE_ADMIN_PASSWORD = 'password'
  ...
  describe('DELETE /admin/estore/<id>/json-schema', () => {
    describe('auth', () => {
      it('204', async () => {
        process.env.ESTORE_ADMIN_PASSWORD = 'password'
        const namespace = 'namespace'
